...
__export(index_exports, {
  ...
  download: () => import_chunk_SZUFDFRI.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_SZUFDFRI.getBinaryName,
  getCacheDir: () => import_chunk_G7EM4XDM.getCacheDir,
  getProxyAgent: () => import_chunk_AGZFDFHU.getProxyAgent,
  getVersion: () => import_chunk_SZUFDFRI.getVersion,
  maybeCopyToTmp: () => import_chunk_SZUFDFRI.maybeCopyToTmp,
  overwriteFile: () => import_chunk_G7EM4XDM.overwriteFile,
  plusX: () => import_chunk_SZUFDFRI.plusX,
  vercelPkgPathRegex: () => import_chunk_SZUFDFRI.vercelPkgPathRegex
});
module.exports = __toCommonJS(index_exports);
var import_chunk_SZUFDFRI = require("./chunk-SZUFDFRI.js");
